#ifndef _ROS_any_msgs_ExtendedJointState_h
#define _ROS_any_msgs_ExtendedJointState_h
...
namespace any_msgs
{
  ...
  class ExtendedJointState : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return "any_msgs/ExtendedJointState"; };
    const char * getMD5(){ return "393848425e33688e4c3305d16bf0a6f6"; };

...
void fillh(void) {
  work.h[0] = -(params.qlow[0]-params.q0[0]);
  work.h[1] = -(params.qlow[1]-params.q0[1]);
  work.h[2] = -(params.qlow[2]-params.q0[2]);
  work.h[3] = -(params.qlow[3]-params.q0[3]);
  work.h[4] = -(params.qlow[4]-params.q0[4]);
  work.h[5] = -(params.qlow[5]-params.q0[5]);
  work.h[6] = -(params.qlow[6]-params.q0[6]);
  work.h[7] = -(params.q0[0]-params.qup[0]);
  work.h[8] = -(params.q0[1]-params.qup[1]);
  work.h[9] = -(params.q0[2]-params.qup[2]);
  work.h[10] = -(params.q0[3]-params.qup[3]);
  work.h[11] = -(params.q0[4]-params.qup[4]);
  work.h[12] = -(params.q0[5]-params.qup[5]);
  work.h[13] = -(params.q0[6]-params.qup[6]);

...
class QpSolverRCMCollision2
{
  ...
  static QpSolverRCMCollision2* me;
	...
	public:
		QpSolverRCMCollision2(float eeLinearVelocityLimit = 0.25f, float eeAngularVelocityLimit = 1.5f, bool enableEECollisionAvoidance = false, float eeSafetyCollisionDistance = 0.0f, 

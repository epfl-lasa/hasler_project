...
namespace custom_msgs_gripper
{
  ...
  class GripperOutputMsg : public ros::Msg
  {
    public:
      ...
      typedef float _gripper_dPosition_type;
      _gripper_dPosition_type gripper_dPosition;
    ...
    virtual int serialize(unsigned char *outbuffer) const
    {
      ...
      *(outbuffer + offset + 3) = (u_gripper_speed.base >> (8 * 3)) & 0xFF;
      ...
      u_gripper_dPosition.real = this->gripper_dPosition;
      *(outbuffer + offset + 0) = (u_gripper_dPosition.base >> (8 * 0)) & 0xFF;
      *(outbuffer + offset + 1) = (u_gripper_dPosition.base >> (8 * 1)) & 0xFF;
      *(outbuffer + offset + 2) = (u_gripper_dPosition.base >> (8 * 2)) & 0xFF;
      *(outbuffer + offset + 3) = (u_gripper_dPosition.base >> (8 * 3)) & 0xFF;
      offset += sizeof(this->gripper_dPosition);
      union {
        int8_t real;
        uint8_t base;
    ...
    virtual int deserialize(unsigned char *inbuffer)
    {
      ...
      u_gripper_dPosition.base = 0;
      u_gripper_dPosition.base |= ((uint32_t) (*(inbuffer + offset + 0))) << (8 * 0);
      u_gripper_dPosition.base |= ((uint32_t) (*(inbuffer + offset + 1))) << (8 * 1);
      u_gripper_dPosition.base |= ((uint32_t) (*(inbuffer + offset + 2))) << (8 * 2);
      u_gripper_dPosition.base |= ((uint32_t) (*(inbuffer + offset + 3))) << (8 * 3);
      this->gripper_dPosition = u_gripper_dPosition.real;
      offset += sizeof(this->gripper_dPosition);
      union {
        int8_t real;
        uint8_t base;
    ...
    const char * getMD5(){ return "0a7045bc28aa869926b3b3d419a0141b"; };

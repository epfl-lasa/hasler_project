#ifndef _ROS_SERVICE_SetUInt32_h
#define _ROS_SERVICE_SetUInt32_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char SETUINT32[] = "any_msgs/SetUInt32";

  class SetUInt32Request : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return SETUINT32; };
    const char * getMD5(){ return "304a39449588c7f8ce2df6e8001c5fce"; };

  };

  class SetUInt32Response : public ros::Msg
  {
    public:

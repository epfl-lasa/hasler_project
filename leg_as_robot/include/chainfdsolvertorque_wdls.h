 ...
 * on the weighted pseudo inverse with damped least-square to calculate the
 * velocity
...
public:
   ...
   *  E_CONVERGE_PINV_SINGULAR=svd solution converged but (pseudo)inverse
   * singular
   *
  ...
  virtual int JntToCart(const JntArray &q_in, const JntArray &torque_in,
  ...
  //  *
  //  */
  // virtual int CartToJnt(const JntArray & /*q_init*/, const JntArray & /*v_in*/,
  //                       Wrench & /*wrench_out*/) {
  //   return -1;
  // };

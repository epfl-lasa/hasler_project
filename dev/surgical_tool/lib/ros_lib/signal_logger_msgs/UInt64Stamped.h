#ifndef _ROS_signal_logger_msgs_UInt64Stamped_h
#define _ROS_signal_logger_msgs_UInt64Stamped_h
...
namespace signal_logger_msgs
{
  ...
  class UInt64Stamped : public ros::Msg
  {
    ...
    const char * getType(){ return "signal_logger_msgs/UInt64Stamped"; };

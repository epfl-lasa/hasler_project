#ifndef _ROS_signal_logger_msgs_UInt16Stamped_h
#define _ROS_signal_logger_msgs_UInt16Stamped_h
...
namespace signal_logger_msgs
{
  ...
  class UInt16Stamped : public ros::Msg
  {
    ...
    const char * getType(){ return "signal_logger_msgs/UInt16Stamped"; };

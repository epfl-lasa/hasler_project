#ifndef _ROS_signal_logger_msgs_Float64Stamped_h
#define _ROS_signal_logger_msgs_Float64Stamped_h
...
namespace signal_logger_msgs
{
  ...
  class Float64Stamped : public ros::Msg
  {
    ...
    const char * getType(){ return "signal_logger_msgs/Float64Stamped"; };

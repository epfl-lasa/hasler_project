#ifndef _ROS_signal_logger_msgs_Int64Stamped_h
#define _ROS_signal_logger_msgs_Int64Stamped_h
...
namespace signal_logger_msgs
{
  ...
  class Int64Stamped : public ros::Msg
  {
    ...
    const char * getType(){ return "signal_logger_msgs/Int64Stamped"; };
    const char * getMD5(){ return "efa2f4712f19644c45429fe3d450cc37"; };

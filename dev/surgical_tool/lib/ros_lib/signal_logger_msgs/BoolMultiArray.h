#ifndef _ROS_signal_logger_msgs_BoolMultiArray_h
#define _ROS_signal_logger_msgs_BoolMultiArray_h
...
namespace signal_logger_msgs
{
  ...
  class BoolMultiArray : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return "signal_logger_msgs/BoolMultiArray"; };
    const char * getMD5(){ return "459966d39a879810df7b9b4bb3254209"; };

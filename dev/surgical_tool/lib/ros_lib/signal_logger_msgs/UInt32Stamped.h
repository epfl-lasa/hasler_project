#ifndef _ROS_signal_logger_msgs_UInt32Stamped_h
#define _ROS_signal_logger_msgs_UInt32Stamped_h
...
namespace signal_logger_msgs
{
  ...
  class UInt32Stamped : public ros::Msg
  {
    ...
    const char * getType(){ return "signal_logger_msgs/UInt32Stamped"; };
    const char * getMD5(){ return "438dd455da526a293dd9eb06485f8a89"; };

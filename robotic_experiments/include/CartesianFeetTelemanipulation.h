#ifndef __CARTESIAN_FEET_TELEMANIPULATION_H__
#define __CARTESIAN_FEET_TELEMANIPULATION_H__
...
class CartesianFeetTelemanipulation 
{
	public:
	...
	public:
		...
		// Class constructor
		CartesianFeetTelemanipulation(ros::NodeHandle &n, double frequency, std::string filename);

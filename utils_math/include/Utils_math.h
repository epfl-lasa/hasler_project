...
class Utils_math 
{
	...
	static Eigen::Matrix<T,Eigen::Dynamic,1> boundNorm(Eigen::Matrix<T,Eigen::Dynamic,1> x, T limit);
	...
	static Eigen::Matrix<T,6,7> getGeometricJacobian7DoF(Eigen::Matrix<T,7,1> joints, Eigen::Matrix<T,3,1> rEEx = Eigen::Matrix<T,3,1>::Zero(), ROBOT_ID roobtID = KUKA_LWR);

	static Eigen::Matrix<T,Eigen::Dynamic,Eigen::Dynamic> pseudoInverseMat(const Eigen::Matrix<T,Eigen::Dynamic,Eigen::Dynamic> &a, T epsilon = FLT_EPSILON);

...
public:
  ...
  ImuWithTrigger(const Time& time, const kindr::RotationQuaternionD& orientation,
                 const kindr::LocalAngularVelocityD& angularVelocity, const kindr::Acceleration3D& linearAcceleration,
...
inline std::ostream& operator<<(std::ostream& os, const ImuWithTrigger& imu)
{
  return os << "Imu (Time: " << imu.time_ << ")"
            ...
            << "\n Angular Velocity: " << imu.angularVelocity_ << "\n tirgger indication: " << std::boolalpha
            << imu.triggerIndicator_;
}

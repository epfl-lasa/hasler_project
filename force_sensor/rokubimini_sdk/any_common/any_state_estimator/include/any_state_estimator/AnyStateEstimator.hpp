...
protected:
   ...
   * @return     true if successful
   */
  bool resetService(any_state_estimator_msgs::ResetStateEstimator::Request& req,
...
protected:
  ...
  cosmo_ros::SubscriberRosPtr<ActuatorReadingsShm, ActuatorReadingsRos,
                              ActuatorReadingsContainer::template ConversionTrait>

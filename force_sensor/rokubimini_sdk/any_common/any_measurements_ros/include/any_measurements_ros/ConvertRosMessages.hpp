...
inline sensor_msgs::Imu::_linear_acceleration_covariance_type
toRos(const any_measurements::ImuWithCovariance::CovarianceMatrix& covariance)
{
...
inline any_measurements::ImuWithCovariance::CovarianceMatrix
fromRos(const sensor_msgs::Imu::_linear_acceleration_covariance_type& msg)
{
  return ConversionTraits<any_measurements::ImuWithCovariance::CovarianceMatrix,
...
inline geometry_msgs::PoseWithCovariance::_covariance_type
toRos(const any_measurements::PoseWithCovariance::CovarianceMatrix& covariance)
{
...
inline any_measurements::PoseWithCovariance::CovarianceMatrix
fromRos(const geometry_msgs::PoseWithCovariance::_covariance_type& msg)
{
  return ConversionTraits<any_measurements::PoseWithCovariance::CovarianceMatrix,
...
{
  return ConversionTraits<any_measurements::PoseWithCovariance, geometry_msgs::PoseWithCovarianceStamped>::convert(
      poseWithCov);
}
...
{
  return ConversionTraits<any_measurements::TwistWithCovariance, geometry_msgs::TwistWithCovarianceStamped>::convert(
      twistWithCov);
}

...
public:
  ...
  */
  ...
  /**
   * @fn bool loadRokubiminiSetup(const setup::Rokubimini *setup)
   *
   * @brief Loads the configuration of the device from the \a {Rokubimini Setup} provided.
   * @param setup The \a {Rokubimini Setup} to load.
   *
   * @return True if the load was successful.
  */
  bool loadRokubiminiSetup(const setup::Rokubimini* setup);
  ...
  */
  ...
  /**
   * @fn virtual void updateSendStagedCommand()
   *
   * @brief Sends a staged Command to the device.
   *
   * This method sends a staged (from the BusManager) \a Command to
   * the device. It's virtual since it's implementation-specific.
   *
  */
  ...
  */
  ...
  /**
   * @fn void stageCommand(const Command &command)
   *
   * @brief Stages a command for the Rokubimini device.
   *
  ...
  */
  ...
  /**
   * @fn bool commandIsStaged() const
   *
   * @brief Checks if the \a Command is staged.
   * @return True if the \a Command is staged.
  */
...
protected:
  /**
   * @fn virtual void dostartupWithCommunication()
   *
   * @brief Starts up a Rokubimini device after communication has been established.
   *
   * This method is virtual because it's implementation-specific.
  ...
  */
  ...
  /**
   * @var mutable std::recursive_mutex stagedCommandMutex_
   *
   * @brief The mutex for accesing the staged command.
   *
  */
  mutable std::recursive_mutex stagedCommandMutex_;

  /**
   * @var Command stagedCommand_
   *
   * @brief The staged command.
   *
  */
  Command stagedCommand_;

  /**
   * @var std::atomic<bool> commandIsStaged_
   *
   * @brief Flag indicating if the command is staged.
   *
  */

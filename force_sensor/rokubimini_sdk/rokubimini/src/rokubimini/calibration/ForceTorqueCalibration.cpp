...
{
  MELO_INFO("[rokubimini][ForceTorqueCalibration][constructor]")
}
...
{
  MELO_INFO("[rokubimini::ForceTorqueCalibration][getCalibParams] solve LS problem")
...
{
  MELO_INFO("[rokubimini::ForceTorqueCalibration][resetCalibration]")
  numMeasurements_ = 0;
}
}  // namespace calibration
}  // namespace rokubimini

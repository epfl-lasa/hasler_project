...
public:
  ...
  template <typename Msg_, typename MsgRos_,
            template <typename, typename> class Converter_ = cosmo_ros::ConversionTraits>
   ...
   * The ROS publisher options (topic, queue size, latch) will be read from the ROS parameter
   * "publishers/parameterName".
  ...
  template <typename Msg_, typename MsgRos_,
            template <typename, typename> class Converter_ = cosmo_ros::ConversionTraits>
  inline cosmo_ros::PublisherRosPtr<Msg_, MsgRos_, Converter_>
  advertiseShmRos(const std::string& name, const cosmo_ros::PublisherRosOptionsPtr& options)
  {
  ...
  template <typename Msg_, typename MsgRos_,
            template <typename, typename> class Converter_ = cosmo_ros::ConversionTraits>
  inline cosmo_ros::PublisherRosPtr<Msg_, MsgRos_, Converter_>
  advertiseShmRos(const std::shared_ptr<cosmo_ros::PublisherRosOptions>& options)
  {
   ...
   */
  template <typename Msg_, typename MsgRos_,
            template <typename, typename> class Converter_ = cosmo_ros::ConversionTraits, typename Obj_>
  inline cosmo_ros::SubscriberRosPtr<Msg_, MsgRos_, Converter_>
  subscribeShmRos(const std::string& name, const std::string& defaultTopic, void (Obj_::*fp)(const Msg_&), Obj_* obj)
  {
    return cosmo_ros::subscribeShmRos<Msg_, MsgRos_, Converter_, Obj_>(*nh_, name, defaultTopic, fp, obj);
  }

  /*! Creates a SubscriberRos with topic name from the ROS parameter server. This function overwrites the nodehandle
  ...
  template <typename Msg_, typename MsgRos_,
            template <typename, typename> class Converter_ = cosmo_ros::ConversionTraits>
  inline cosmo_ros::SubscriberRosPtr<Msg_, MsgRos_, Converter_>
  subscribeShmRos(const std::string& name, const cosmo_ros::SubscriberRosOptionsPtr<Msg_>& options)
  {
    options->nodeHandle_ = *nh_;
  ...
  template <typename Msg_, typename MsgRos_,
            template <typename, typename> class Converter_ = cosmo_ros::ConversionTraits>
  inline cosmo_ros::SubscriberRosPtr<Msg_, MsgRos_, Converter_>
  subscribeShmRos(const std::shared_ptr<cosmo_ros::SubscriberRosOptions<Msg_>>& options)
  {
    options->nodeHandle_ = *nh_;

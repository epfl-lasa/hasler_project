...
namespace cosmo
{
class SyncMaster : virtual private Publisher<SyncMessage, DEFAULT_ALIGNMENT>
{
public:
  using BaseType = Publisher<SyncMessage, DEFAULT_ALIGNMENT>;
   ...
   */
  SyncMaster(const std::string& topic, const double timeStep, const int syncThreadPriority = 79,

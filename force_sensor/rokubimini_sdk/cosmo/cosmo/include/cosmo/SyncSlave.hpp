...
namespace cosmo
{
class SyncSlave : virtual private Subscriber<SyncMessage, DEFAULT_ALIGNMENT>
{
public:
  using BaseType = Subscriber<SyncMessage, DEFAULT_ALIGNMENT>;
   ...
   */
  SyncSlave(const std::string& topic, const int syncThreadPriority = 59)

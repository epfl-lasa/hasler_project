...
TEST(SmartPointerIterator, observerPointer)
{
...

  {
    ...
    base_observer_container.insert(base_observer_container.end(), observer_iterable_a.s_begin(),
                                   observer_iterable_a.s_end());

    base_observer_container.insert(base_observer_container.end(), observer_iterable_b.s_begin(),

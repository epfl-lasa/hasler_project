...
// Define the map
typedef CompileTimeMap<
    Things, Types, kv<Things::CAT, Types::ANIMAL>, kv<Things::GREEN, Types::COLOR>, kv<Things::USA, Types::COUNTRY>,
    kv<Things::DOG, Types::ANIMAL>, kv<Things::ELEPHANT, Types::ANIMAL>, kv<Things::SWITZERLAND, Types::COUNTRY>,
    kv<Things::RED, Types::COLOR>, kv<Things::COMPUTER, Types::DEVICE>, kv<Things::GERMANY, Types::COUNTRY>,
    kv<Things::SHEEP, Types::ANIMAL>, kv<Things::BELGIUM, Types::COUNTRY>, kv<Things::IPHONE, Types::DEVICE>,
    kv<Things::LAPTOP, Types::DEVICE>, kv<Things::ENGLAND, Types::COUNTRY>, kv<Things::SWEDEN, Types::COUNTRY>,
    kv<Things::TABLET, Types::DEVICE>, kv<Things::DUCK, Types::ANIMAL>, kv<Things::COW, Types::ANIMAL>,
    kv<Things::BLUE, Types::COLOR>, kv<Things::YELLOW, Types::COLOR>>
    ctm;

//! Map with wrong key type int
typedef CompileTimeMap<Things, Types, KeyValuePair<Things, int, Things::CAT, 2>> ctm_wrongKey;

//! Wrong type int within map
typedef CompileTimeMap<Things, Types, kv<Things::CAT, Types::ANIMAL>, int> ctm_wrongType;

//! Same key multiple times
typedef CompileTimeMap<Things, Types, kv<Things::CAT, Types::ANIMAL>, kv<Things::CAT, Types::ANIMAL>> ctm_keyNotUnique;
...
int main()
{
  ...
  std::cout << "All Things smaller 10: " << std::boolalpha
            << ctm::forEach([](const Things& thing, const Types& type) { return static_cast<int>(thing) < 10; })
            << std::endl;
  ...
  ctmSubenum::forEach([](const Types& type, const Things& thing) {
    std::cout << "Type: " << static_cast<int>(type) << " maps to thing: " << static_cast<int>(thing) << "."
              << std::endl;
    return true;
  });
  ...
  using ctm_thingsub = CompileTimeMap<ThingSub, Things, KeyValuePair<ThingSub, Things, ThingSub::SubCat, Things::CAT>,
                                      KeyValuePair<ThingSub, Things, ThingSub::SubGreen, Things::GREEN>>;
  CONSECUTIVE_ENUM(TypeSub, SubAnimal, SubColor);
  using ctm_typesub = CompileTimeMap<TypeSub, Types, KeyValuePair<TypeSub, Types, TypeSub::SubAnimal, Types::ANIMAL>,
                                     KeyValuePair<TypeSub, Types, TypeSub::SubColor, Types::COLOR>>;
  using ctm_thingtypesub =
      CompileTimeMap<ThingSub, TypeSub, KeyValuePair<ThingSub, TypeSub, ThingSub::SubGreen, TypeSub::SubColor>,
  ...
  // Add to ctm values
  using ctm_add_prev = CompileTimeMap<TypeSub, int, KeyValuePair<TypeSub, int, TypeSub::SubAnimal, 2>,
  ...
  std::cout << "Known element CAT // Unordered Map took: " << um << " ns. Constexpr CTM took: " << ctc << " ns."
            << std::endl;

 ...
 */
#define CONSECUTIVE_ENUM(Name, FirstElement, ...)                                                                      \
...
#define CONSECUTIVE_ENUM_EMPTY(Name)                                                                                   \
  enum class Name : unsigned int                                                                                       \
  {                                                                                                                    \
    SIZE = 0                                                                                                           \
  };
...
public:
  ...
  constexpr enum_iterator() noexcept : id_{ 0 }  // Assumes 0 is the first constant
  {
  }

  constexpr enum_iterator(const EnumType_ index) noexcept : id_{ static_cast<integer_type>(index) }
  {
  }

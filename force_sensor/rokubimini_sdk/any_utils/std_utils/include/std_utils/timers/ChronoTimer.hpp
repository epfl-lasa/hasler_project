...
public:
  ...
  explicit ChronoTimer(const std::string& timerNamespace = "") : alpha_(0.01), timerNamespace_(timerNamespace)
  {
  ...
  /*! The average split time is obtained by alpha filtering the incoming split times. Set the alpha parameter of the
   * filter.
   */
  ...
  /*! The average split time is obtained by alpha filtering the incoming split times. Get the alpha parameter of the
   * filter.
   */
   ...
   */
  void setTimerNamespace(const std::string& timerNamespace)
  {
   ...
   */
  const std::string& getTimerNamespace() const
  {
    return timerNamespace_;
  }

...
#define TYPESTRING4(n, x)                                                                                              \
  std_utils::tygrab<0x##n##0>(x), std_utils::tygrab<0x##n##1>(x), std_utils::tygrab<0x##n##2>(x),                      \
      std_utils::tygrab<0x##n##3>(x)

/* 2^3 = 8 */
#define TYPESTRING8(n, x)                                                                                              \
  std_utils::tygrab<0x##n##0>(x), std_utils::tygrab<0x##n##1>(x), std_utils::tygrab<0x##n##2>(x),                      \
      std_utils::tygrab<0x##n##3>(x), std_utils::tygrab<0x##n##4>(x), std_utils::tygrab<0x##n##5>(x),                  \
      std_utils::tygrab<0x##n##6>(x), std_utils::tygrab<0x##n##7>(x)

/* 2^4 = 16 */
#define TYPESTRING16(n, x)                                                                                             \
  std_utils::tygrab<0x##n##0>(x), std_utils::tygrab<0x##n##1>(x), std_utils::tygrab<0x##n##2>(x),                      \
      std_utils::tygrab<0x##n##3>(x), std_utils::tygrab<0x##n##4>(x), std_utils::tygrab<0x##n##5>(x),                  \
      std_utils::tygrab<0x##n##6>(x), std_utils::tygrab<0x##n##7>(x), std_utils::tygrab<0x##n##8>(x),                  \
      std_utils::tygrab<0x##n##9>(x), std_utils::tygrab<0x##n##A>(x), std_utils::tygrab<0x##n##B>(x),                  \
      std_utils::tygrab<0x##n##C>(x), std_utils::tygrab<0x##n##D>(x), std_utils::tygrab<0x##n##E>(x),                  \
      std_utils::tygrab<0x##n##F>(x)
...
#define TYPESTRING128(n, x)                                                                                            \
  TYPESTRING16(n##0, x)                                                                                                \
  , TYPESTRING16(n##1, x), TYPESTRING16(n##2, x), TYPESTRING16(n##3, x), TYPESTRING16(n##4, x), TYPESTRING16(n##5, x), \
...
#define TYPESTRING256(n, x)                                                                                            \
  TYPESTRING16(n##0, x)                                                                                                \
  , TYPESTRING16(n##1, x), TYPESTRING16(n##2, x), TYPESTRING16(n##3, x), TYPESTRING16(n##4, x), TYPESTRING16(n##5, x), \
      TYPESTRING16(n##6, x), TYPESTRING16(n##7, x), TYPESTRING16(n##8, x), TYPESTRING16(n##9, x),                      \
      TYPESTRING16(n##A, x), TYPESTRING16(n##B, x), TYPESTRING16(n##C, x), TYPESTRING16(n##D, x),                      \
      TYPESTRING16(n##E, x), TYPESTRING16(n##F, x)
...
#define TYPESTRING1024(n, x)                                                                                           \
  TYPESTRING256(n##0, x)                                                                                               \
  , TYPESTRING256(n##1, x), TYPESTRING256(n##2, x), TYPESTRING128(n##3, x), TYPESTRING16(n##38, x),                    \
      TYPESTRING16(n##39, x), TYPESTRING16(n##3A, x), TYPESTRING16(n##3B, x), TYPESTRING16(n##3C, x),                  \

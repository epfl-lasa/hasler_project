...
public:
  ...
  static_assert(std_utils::traits::is_smart_ptr<value_type>::value,
                "smart_pointer_iterator is only valid for smart pointers");
  ...
  pointer operator*()
  {
    return (this->base_iterator::operator*()).get();
  }

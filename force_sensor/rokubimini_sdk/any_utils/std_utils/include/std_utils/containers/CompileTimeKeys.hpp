...
public:
  ...
  {
    return std_utils::KeyArray<Enum_, 0>{ {} };
  }
...
public:
  ...
  */
  static constexpr std::size_t size()
  {
    return 1 + CompileTimeKeys<Enum_, REST_...>::size();
  }
                   ...
                   CompileTimeMap<Enum1_, TransformedEnum_, KV1_...>, CompileTimeMap<Enum2_, TransformedEnum_, KV2_...>>
{
  using type = std_utils::ctk_concatenate_t<
      TransformedEnum_, std_utils::ctk_transform_t<TransformedEnum_, CompileTimeKeys<Enum1_, Keys1_...>,
                                                   CompileTimeMap<Enum1_, TransformedEnum_, KV1_...>>,
      std_utils::ctk_transform_t<TransformedEnum_, CompileTimeKeys<Enum2_, Keys2_...>,
                                 CompileTimeMap<Enum2_, TransformedEnum_, KV2_...>, static_cast<int>(Enum1_::SIZE)>>;
};

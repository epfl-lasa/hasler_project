...
public:
  ...
  smart_iterator begin()
  {
    return std_utils::dereference_iterator<element_type>(items_.begin());
  }
  smart_iterator end()
  {
    return std_utils::dereference_iterator<element_type>(items_.end());
  }
  smart_const_iterator begin() const
  {
    return std_utils::dereference_iterator<const element_type>(items_.begin());
  }
  smart_const_iterator end() const
  {
    return std_utils::dereference_iterator<const element_type>(items_.end());
  }
...
using UnorderedMapOfUniquePtrs =
    std_utils::smart_pointer_dictionary<key_type, element_type, std::unique_ptr, std::unordered_map>;
}
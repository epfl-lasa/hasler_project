...
struct WriteXMLFixture : public ::testing::Test
{
  ...
  {
    xmlDocument_->SaveFile("xml_files/Generated.xml");
  }
...
TEST_F(WriteXMLFixture, writePrimitiveTypes)
{  // NOLINT
...
TEST_F(WriteXMLFixture, writeSTL)
{  // NOLINT
...
TEST_F(WriteXMLFixture, writeEigen)
{  // NOLINT
  ...
  tinyxml_tools::writeParameter("Eigen/Matrices/Dynamic", matrix22Dynamic, xmlRootHandle_,
                                { "v15", "v30", "v45", "v60" });
}

TEST_F(WriteXMLFixture, writeSiblings)
{  // NOLINT

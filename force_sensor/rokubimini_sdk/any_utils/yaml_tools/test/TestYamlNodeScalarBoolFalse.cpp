...
TEST_F(TestYamlNodeScalarBoolFalse, throwsExceptionOnBadCast)
{  // NOLINT
...
TEST_F(TestYamlNodeScalarBoolFalse, accessValue)
{  // NOLINT
  EXPECT_EQ(value_, yamlNode_.as<Type>());
}

TEST_F(TestYamlNodeScalarBoolFalse, writeToString)
{  // NOLINT
  EXPECT_EQ(valueAsString_, yamlNode_.toString());
}

TEST_F(TestYamlNodeScalarBoolFalse, readFromString)
{  // NOLINT

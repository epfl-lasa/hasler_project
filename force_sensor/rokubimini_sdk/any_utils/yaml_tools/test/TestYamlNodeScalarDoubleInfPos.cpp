...
TEST_F(TestYamlNodeScalarDoubleInfPos, throwsExceptionOnBadCast)
{  // NOLINT
...
TEST_F(TestYamlNodeScalarDoubleInfPos, accessValue)
{  // NOLINT
  EXPECT_EQ(value_, yamlNode_.as<Type>());
}

TEST_F(TestYamlNodeScalarDoubleInfPos, writeToString)
{  // NOLINT
  EXPECT_EQ(valueAsString_, yamlNode_.toString());
}

TEST_F(TestYamlNodeScalarDoubleInfPos, readFromString)
{  // NOLINT

...
TEST_F(TestYamlNodeScalarDoubleInfNeg, throwsExceptionOnBadCast)
{  // NOLINT
...
TEST_F(TestYamlNodeScalarDoubleInfNeg, accessValue)
{  // NOLINT
  EXPECT_EQ(value_, yamlNode_.as<Type>());
}

TEST_F(TestYamlNodeScalarDoubleInfNeg, writeToString)
{  // NOLINT
  EXPECT_EQ(valueAsString_, yamlNode_.toString());
}

TEST_F(TestYamlNodeScalarDoubleInfNeg, readFromString)
{  // NOLINT

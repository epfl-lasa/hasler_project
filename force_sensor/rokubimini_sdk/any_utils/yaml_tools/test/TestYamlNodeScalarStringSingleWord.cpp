...
TEST_F(TestYamlNodeScalarStringSingleWord, throwsExceptionOnBadCast)
{  // NOLINT
...
TEST_F(TestYamlNodeScalarStringSingleWord, accessValue)
{  // NOLINT
  EXPECT_EQ(value_, yamlNode_.as<std::string>());
}

TEST_F(TestYamlNodeScalarStringSingleWord, writeToString)
{  // NOLINT
  EXPECT_EQ(valueAsString_, yamlNode_.toString());
}

TEST_F(TestYamlNodeScalarStringSingleWord, readFromString)
{  // NOLINT

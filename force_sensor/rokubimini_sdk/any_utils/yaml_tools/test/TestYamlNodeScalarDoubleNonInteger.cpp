...
TEST_F(TestYamlNodeScalarDoubleNonInteger, throwsExceptionOnBadCast)
{  // NOLINT
...
TEST_F(TestYamlNodeScalarDoubleNonInteger, accessValue)
{  // NOLINT
  EXPECT_EQ(value_, yamlNode_.as<Type>());
}

TEST_F(TestYamlNodeScalarDoubleNonInteger, writeToString)
{  // NOLINT
  EXPECT_EQ(valueAsString_, yamlNode_.toString());
}

TEST_F(TestYamlNodeScalarDoubleNonInteger, readFromString)
{  // NOLINT

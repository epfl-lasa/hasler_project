...
TEST_F(TestYamlNodeScalarBoolTrue, throwsExceptionOnBadCast)
{  // NOLINT
...
TEST_F(TestYamlNodeScalarBoolTrue, accessValue)
{  // NOLINT
  EXPECT_EQ(value_, yamlNode_.as<Type>());
}

TEST_F(TestYamlNodeScalarBoolTrue, writeToString)
{  // NOLINT
  EXPECT_EQ(valueAsString_, yamlNode_.toString());
}

TEST_F(TestYamlNodeScalarBoolTrue, readFromString)
{  // NOLINT

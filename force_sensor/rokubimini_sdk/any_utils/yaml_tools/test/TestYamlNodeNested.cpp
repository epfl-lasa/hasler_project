...
protected:
  void SetUp() override
  {
    ...
    yaml_tools::YamlNode yaml_node_map;
    yamlNodeMapRoot_[mapKeyRoot_] = yaml_node_map;

    // Add map 0 to sequence.
    yaml_tools::YamlNode yaml_node_map0;
    yaml_node_map.pushBack(yaml_node_map0);
    yaml_node_map[0][bool0_.first] = bool0_.second;
    yaml_node_map[0][integer0_.first] = integer0_.second;
    ...
    yaml_tools::YamlNode yaml_node_map1;
    yaml_node_map1[bool1_.first] = bool1_.second;
    yaml_node_map1[integer1_.first] = integer1_.second;
    yaml_node_map.pushBack(yaml_node_map1);
    yaml_node_map1[double1_.first] = double1_.second;
    yaml_node_map1[string1_.first] = string1_.second;
  }
...
TEST_F(TestYamlNodeNested, nestedMemberAccessAndCasting)
{  // NOLINT
...
TEST_F(TestYamlNodeNested, nestedKeys)
{  // NOLINT

...
TEST_F(TestYamlNodeScalarInteger, throwsExceptionOnBadCast)
{  // NOLINT
...
TEST_F(TestYamlNodeScalarInteger, accessValue)
{  // NOLINT
  EXPECT_EQ(value_, yamlNode_.as<Type>());
}

TEST_F(TestYamlNodeScalarInteger, writeToString)
{  // NOLINT
  EXPECT_EQ(valueAsString_, yamlNode_.toString());
}

TEST_F(TestYamlNodeScalarInteger, readFromString)
{  // NOLINT

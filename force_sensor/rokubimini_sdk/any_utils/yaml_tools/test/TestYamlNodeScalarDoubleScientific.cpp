...
TEST_F(TestYamlNodeScalarDoubleScientific, throwsExceptionOnBadCast)
{  // NOLINT
...
TEST_F(TestYamlNodeScalarDoubleScientific, accessValue)
{  // NOLINT
  EXPECT_EQ(value_, yamlNode_.as<Type>());
}

TEST_F(TestYamlNodeScalarDoubleScientific, writeToString)
{  // NOLINT
  EXPECT_EQ(valueAsString_, yamlNode_.toString());
}

TEST_F(TestYamlNodeScalarDoubleScientific, readFromString)
{  // NOLINT

...
TEST_F(TestYamlNodeScalarStringMultipleWords, throwsExceptionOnBadCast)
{  // NOLINT
...
TEST_F(TestYamlNodeScalarStringMultipleWords, accessValue)
{  // NOLINT
  EXPECT_EQ(value_, yamlNode_.as<std::string>());
}

TEST_F(TestYamlNodeScalarStringMultipleWords, writeToString)
{  // NOLINT
  EXPECT_EQ(valueAsString_, yamlNode_.toString());
}

TEST_F(TestYamlNodeScalarStringMultipleWords, readFromString)
{  // NOLINT

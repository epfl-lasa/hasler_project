...
{
  frictionLogger::Platform_Name platform_id_;
  ...
  if (argc>=2)
  {
    if (std::string(argv[1])=="left") {platform_id_=frictionLogger::LEFT;}
    else if (std::string(argv[1])=="right") {platform_id_=frictionLogger::RIGHT;}
    else
    {

#ifndef __frictionLogger_H__
#define __frictionLogger_H__
...
class frictionLogger
{
    ...
    public:
        ...
        NEW_DATA_POINT,  CHANGE_AXIS,  REQ_TELEOP_CTRL, REQ_TORQUE_CTRL,  COMP_FRICTION, ID_FRICTION , STOP_ALL};
    private:
    ...
    custom_msgs::FootOutputMsg_v2 _msgStaticFriction;
...
// METHODS
	public:
	frictionLogger(ros::NodeHandle &n_1, double frequency, frictionLogger::Platform_Name platform_id_, Axis axis_, std::string filename_);
